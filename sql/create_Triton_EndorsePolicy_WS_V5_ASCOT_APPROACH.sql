...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Get charge code for endorsement premium
        SELECT TOP 1 @ChargeCode = ChargeCode
        FROM lstCharges
        WHERE ChargeID = 'BASE'  -- Base premium charge
        
        -- Get office ID from the original quote option
        SELECT TOP 1 @OfficeID = qop.OfficeID
