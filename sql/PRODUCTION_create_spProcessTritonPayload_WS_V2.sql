-- Production stored procedure to process Triton payload data V2
-- UPDATED VERSION: 
-- - Adds policy_fee and tax fields to tblTritonQuoteData
-- - Only calls spAutoApplyFees if stamping_fee and surplus_lines_tax are blank
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- 5. Register the premium using UpdatePremiumHistoricV3
...
PRINT 'Stored procedure spProcessTritonPayload_WS V2 created successfully';
GO