USE [Greyhawk_Test]
GO
/****** Object:  StoredProcedure [dbo].[Ascot_EndorsePolicy]    Script Date: 7/17/2025 10:22:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[Ascot_EndorsePolicy]
(
...
BEGIN
	...
	FOR SELECT	NewQuoteOptions.QuoteOptionGuid,
		...
		OUTER APPLY (
						SELECT	Ascot_AL3QuoteDetailTable.Premium,
								Ascot_AL3QuoteDetailTable.Terrorism,
