    ...
    def store_triton_data(self, quote_guid: UUID, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            params = {
                ...
                "PolicyFee": str(data.get("policy_fee", 0)) if data.get("policy_fee") else None,
                "SurplusLinesTax": str(data.get("surplus_lines_tax", 0)) if data.get("surplus_lines_tax") else None,
                "StampingFee": str(data.get("stamping_fee", 0)) if data.get("stamping_fee") else None,
                "OtherFee": str(data.get("other_fee", 0)) if data.get("other_fee") else None,
                "CommissionPercent": str(data.get("commission_percent", 0)) if data.get("commission_percent") else None,
                "CommissionAmount": str(data.get("commission_amount", 0)) if data.get("commission_amount") else None,
                "NetPremium": str(data.get("net_premium", 0)) if data.get("net_premium") else None,
                "BasePremium": str(data.get("base_premium", 0)) if data.get("base_premium") else None,
