USE [Greyhawk_Test]
GO
/****** Object:  StoredProcedure [dbo].[Ascot_CancelPolicy_V6]    Script Date: 7/17/2025 10:24:33 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[Ascot_CancelPolicy_V6]
(
		...
		BEGIN
			...
			BEGIN   
					...
					IF OBJECT_ID('tempdb..#TridentLineGuid') IS NOT NULL BEGIN DROP TABLE #TridentLineGuid END
							...
							--select Lineguid into #TridentLineGuid from lstlines where linename like '%Program Trident%'
